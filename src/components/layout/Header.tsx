        ...
        <div className="w-full max-w-[1440px] pointer-events-auto">
          <div className="flex items-center justify-between gap-6 lg:gap-8 xl:gap-12">
            ...
            <div className="flex items-center shrink-0">
              <Link
                href="/"
                aria-label="The PM Properties — Go to homepage"
                className="relative h-20 w-56 sm:h-24 sm:w-64 lg:h-28 lg:w-72 shrink-0 opacity-90 hover:opacity-100 transition-opacity"
                prefetch={false}
              >
                <Image
                  src="/images/logo.png"
            ...
            {/* ── Desktop Navigation (Middle Bar) ────────────── */}
            <div className="hidden xl:flex items-center justify-center flex-1 min-w-0 px-2">
              <nav
                aria-label="Main navigation"
                className="flex items-center gap-0.5 xl:gap-1 bg-white rounded-full p-1.5 shadow-xl"
              >
                {NAV_ITEMS.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`
                        relative flex items-center px-4 xl:px-4.5 2xl:px-5 py-2.5 rounded-full
                        font-heading text-[14.5px] xl:text-[15px] lg:text-base font-semibold leading-none whitespace-nowrap
            ...
            <div className="flex items-center gap-3 shrink-0 ml-2 xl:ml-6">
              <div className="hidden sm:flex items-center gap-1 bg-white rounded-full p-1.5 shadow-xl shrink-0">
                <button
                  type="button"
                  onClick={() => {
                    trackCtaClick({
                  ...
                  className="px-6 py-2.5 rounded-full font-heading text-[15px] lg:text-base font-bold leading-none bg-[#0a0a0a] text-white hover:bg-black shadow-md transition-all duration-200 cursor-pointer whitespace-nowrap"
                >
                  Book Consultation
                </button>
              </div>
              ...
              <button
                ...
                className="xl:hidden p-3 rounded-full bg-white text-[#0a0a0a] shadow-xl hover:bg-gray-50 transition-all duration-200"
