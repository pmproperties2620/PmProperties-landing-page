  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col items-end">
          ...
          >
            ...
            <div className="p-4 bg-white flex justify-center">
              <a
                ...
                className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-heading font-semibold text-sm lg:text-[15px] leading-none py-3 px-6 rounded-full flex items-center justify-center gap-2 transition-colors shadow-md"
              >
      ...
      >
        ...
        {!isOpen && (
          <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-heading font-black leading-none w-5 h-5 flex items-center justify-center rounded-full border-2 border-white">
            1
          </span>
        )}
      </motion.button>
